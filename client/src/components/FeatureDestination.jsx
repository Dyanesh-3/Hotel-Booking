  ...
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 py-20'>
      <Title title='Featured Destinations' subTitle='Discover our handpicked selection of exceptional properties around the world, offering unparalleled luxury and unforgettable experiences.'/>
        ...
        <button onClick={() => { navigate('/rooms'); window.scrollTo(0,0); }} className='mt-10 px-6 py-2 text-sm font-medium border border-grey-300 rounded hover:bg-grey-50 transition-all cursor-pointer'>

...
const Hotelcard = ({room, index}) => {
  return (
                <Link to={'/room/' + room._id} onClick={() => scrollTo(0,0)} keys={room._id} className='relative max-w-70 w-full rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_4px_0px_rgba(0,0,0,0.05)]'>
        ...
        <div className='p-4 pt-5'>   
            ...
            <div className='flex items-center justify-between mt-4'> 
                ...
                <button className='px-4 py-2 text-sm font-medium border border-grey-300 rounded hover:bg-grey-50 transition-all cursor-pointer'></button>
            </div>
        </div>
    </Link>
  )
